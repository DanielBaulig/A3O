...
--
-- Host: localhost
-- Erstellungszeit: 30. Juli 2010 um 20:51
...
CREATE TABLE IF NOT EXISTS a3o_basezones (
  ...
  basezone_production tinyint(4) NOT NULL,
  basezone_water tinyint(1) NOT NULL,
  ...
  KEY basezone_name_2 (basezone_name)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Base zones for each game';
...
CREATE TABLE IF NOT EXISTS a3o_players (
  ...
  PRIMARY KEY (player_user,player_nation,player_match),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Current zones in a match';
